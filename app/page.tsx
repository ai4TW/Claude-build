...
const features = [
  ...
  { icon: "🎯", title: "Industry-Specific Qualification", desc: "The right questions for your business: law firms ask about case type, medical offices ask about insurance, home services ask about urgency and location." },
        ...
        <div style={{ position: "relative", zIndex: 10, maxWidth: "1152px", margin: "0 auto", padding: "6rem 1rem", width: "100%" }}>
          <div style={{ maxWidth: "640px" }}>
            ...
            <p style={{ fontSize: "clamp(1rem, 2vw, 1.2rem)", color: "rgba(255,255,255,0.6)", marginBottom: "32px", lineHeight: 1.7, maxWidth: "520px" }}>
              Your AI receptionist answers every call in your name, qualifies every caller, and sends SMS follow-ups — 24/7. Works for any business.
            </p>
            ...
            <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.3)" }}>Cancel anytime · No contracts</p>
          </div>
        </div>
      </section>
