...
## Email 1 — Day 1: Intro + Hook

**Subject:** You missed a call while showing a house today

**Preview text:** Every missed call is a lead walking to your competitor.

---

Hi {{first_name}},

Quick question: how many calls did you miss this week while you were in a showing, on the road, or just living your life?
...
Takes 10 minutes to set up. Costs less than one lost commission.
...
**Subject:** How Sarah went from 4 missed calls/day to zero

**Preview text:** She almost didn't try it. Now she won't go back.

---

Hi {{first_name}},

Sarah Chen is a solo agent in Phoenix. Last year, she was losing an average of 4 calls a day to voicemail — calls she couldn't return until hours later, if at all.
...
- Sends you a summary via text/email instantly
...
## Email 3 — Day 5: Pain-Focused

**Subject:** The $15,000 voicemail problem

**Preview text:** One missed call. One lost listing. Do the math.

---

Hi {{first_name}},

Let's talk about what a missed call actually costs you.

Average commission on a home sale in the U.S.: ~$9,000–$15,000.

If a motivated seller calls you while you're in a showing and you don't answer, what are the odds they call the next agent on their list?
...
- Instant lead summaries sent to you by text
...
*The agents gaining market share right now aren't working more hours. They're just not missing calls.*
...
I've heard this one before: *"I already have voicemail."*

Fair enough. But here's the difference:
...
**[Let's talk — grab a free demo →]**

{{sender_name}}

---

## Email 5 — Day 12: Breakup / Last Attempt

**Subject:** Last one from me, {{first_name}}

**Preview text:** If the timing's not right, no hard feelings.

---

Hi {{first_name}},

I've reached out a few times — I won't keep filling your inbox if this isn't a fit.
...
If you're curious — even a little — **[grab 15 minutes with me here →]** and I'll show you exactly how it works with zero sales pressure.
...
| Email | Day | Subject | Angle |
|-------|-----|---------|-------|
| 1 | Day 1 | You missed a call while showing a house today | Intro + hook on missed calls |
| 2 | Day 3 | How Sarah went from 4 missed calls/day to zero | Social proof / case study |
| 3 | Day 5 | The $15,000 voicemail problem | Pain + cost of missed calls |
| 4 | Day 8 | "I already have a voicemail for that" | Objection handling |
| 5 | Day 12 | Last one from me | Breakup / re-engagement |

## Sending Notes

- **From name:** Use sender's real name (not company name) for higher open rates
- **Personalization:** Swap `{{first_name}}` from license record data; add local market reference where possible
- **CTA:** Link to Calendly or equivalent booking tool
- **Send time:** Tuesday–Thursday, 7–9am or 4–6pm local time
- **Unsubscribe:** Include compliant footer per CAN-SPAM
- **Domain:** Warm up sending domain before blasting full list
