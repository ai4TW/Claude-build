...
## How to schedule in Buffer

1. Go to [buffer.com](https://buffer.com) and log in
2. Connect your LinkedIn personal profile (not company page)
3. For each post below, click **+** → LinkedIn → paste post text → set date/time → **Add to Queue**
4. Repeat for all 10 posts
...
**8:00 AM — Post 1: The $50K Problem**
...
**12:00 PM — Post 2: The MIT Study That Changes Everything**
...
**8:00 AM — Post 3: Founder Origin Story**
...
**12:00 PM — Post 4: The Hidden Cost of Voicemail**
...
**8:00 AM — Post 5: Objection — "Virtual Receptionists Don't Know Real Estate"**
...
**12:00 PM — Post 6: The Weekend Problem**
...
**12:00 PM — Post 8: What Top Producers Have That Others Don't**
...
- [ ] Post 1 scheduled (Mon Apr 6, 8 AM)
- [ ] Post 2 scheduled (Mon Apr 6, 12 PM)
- [ ] Post 3 scheduled (Tue Apr 7, 8 AM)
- [ ] Post 4 scheduled (Tue Apr 7, 12 PM)
- [ ] Post 5 scheduled (Wed Apr 8, 8 AM)
- [ ] Post 6 scheduled (Wed Apr 8, 12 PM)
- [ ] Post 7 scheduled (Thu Apr 9, 8 AM)
- [ ] Post 8 scheduled (Thu Apr 9, 12 PM)
- [ ] Post 9 scheduled (Fri Apr 10, 8 AM)
- [ ] Post 10 scheduled (Fri Apr 10, 12 PM)
