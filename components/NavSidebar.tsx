...
export default function NavSidebar({ clientName }: { clientName: string }) {
  ...
  return (
    <aside className="w-60 bg-brand-900 flex flex-col">
      ...
      {/* Client badge */}
      <div className="px-5 py-3 border-b border-brand-700">
        <p className="text-brand-100 text-xs opacity-60 uppercase tracking-wider mb-1">Logged in as</p>
      ...
      <div className="px-3 py-4 border-t border-brand-700">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium text-brand-100 opacity-70 hover:opacity-100 hover:bg-brand-700 transition-colors"
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
